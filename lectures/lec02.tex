...
\begin{defn*}[Ring of algebraic integers]\index{Ring!of algebraic integers}
...
\begin{defn*}[Trace and norm of a number field]\index{Number field!Trace}\index{Number field!Norm}
