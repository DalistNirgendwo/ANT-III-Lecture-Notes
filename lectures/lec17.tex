...
\begin{thm*}[Subspace Theorem, Schmidt, 1972]\index[theorem]{Subspace theorem}
...
\begin{defn*}[Algebraic and transcendental numbers]\index{Transcendence}
...
\begin{defn*}[Transcendence degree, trancendence basis]\index{Transcendence!Transcendence degree}
	Let \( S \subseteq \C \).
