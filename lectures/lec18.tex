...
\begin{rem*}
	In the proof of \Cref{thm:4.8} we showd that for any \( n \in \N \), the numbers \( 1, e, e^2, \dotsc, e^n \) are linearly independent over \( \Q \) (and hence over \( \bar{\Q} \)). 
\end{rem*}
...
We certainly need the \( \alpha_i \) to be distinct, as for example \( 1 \cdot e^\alpha + (-1) \cdot e^\alpha = 0 \) for all \( \alpha \in \bar{\Q} \).

\begin{thmn}[Baker\protect\footnotemark{}, Lindemann\protect\footnotemark{}-Weierstraß\protect\footnotemark{}]\label{thm:4.15}
	\footnotetext{Alan Baker (1939 - 2018), an English mathematician}
	\footnotetext{after Ferdinand von Lindemann (1852-1939), a German mathematician,}
	\footnotetext{and Karl Weierstraß (1815-1879), a German mathematician}
